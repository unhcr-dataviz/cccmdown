...
Use the [`{unhcrthemes}`](https://github.com/unhcr-dataviz/unhcrthemes) package to produce UNHCR branded plots directly in the presentation. Will be adapted soon for CCCM. For example: 

```{r idp-plot, fig.align = "center", out.width = "90%", warning = FALSE, echo = TRUE}
ggplot(
    mtcars,
    aes(x = hp, y = mpg)
) +
